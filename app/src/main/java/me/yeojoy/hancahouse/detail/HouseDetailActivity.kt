...
class HouseDetailActivity : AppCompatActivity(), ItemDetailContract.View<House> {

    companion object {
        private val TAG = HouseDetailActivity::class.java.simpleName
    }
    ...
    private lateinit var presenter : ItemDetailContract.Presenter<House>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_item)
        setPresenter(HouseDetailPresenter(this))
        ...
        val item = intent.getParcelableExtra(Constants.KEY_ITEM) as House?
    ...
    override fun onGetEmailAddress(emailAddress: String) {
        ...
        Toast.makeText(this@HouseDetailActivity, "email", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onGetTelephoneNumber(telephoneNumber: String) {
        ...
        Toast.makeText(this@HouseDetailActivity, "phone", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun setPresenter(presenter: ItemDetailContract.Presenter<House>) {
